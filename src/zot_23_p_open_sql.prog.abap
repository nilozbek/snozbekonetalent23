...
*DATA gs_eban TYPE eban.  "satırı alıyo?
*
*DATA gt_eban TYPE TABLE OF eban.
*
*START-OF-SELECTION.
*
*  SELECT SINGLE banfn  "gördüğü ilk değişkeni al demek oluyo
*  FROM eban
*  WHERE banfn NE @space "banfn fieldı boş olmayanlar arasından seç NE not equal demek
*  INTO @gv_banfn.
*
*
*  WRITE :/ gv_banfn.
